...
mem_size = 1       # Memory size for experience replay
batch_size = 1     # Batch size when updating NN


class SimpleNNLearner(object):
    ...
    def __init__(self):
        ...
        for i in range(2):
            for j in range(2):
                ...
                model.load_weights(f"simple_nn_{i}{j}.h5")
