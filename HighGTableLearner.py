...
low_tree_dist_bin_size = 25  # Can be set to 0, will then discard this variable
low_relative_dist_bin_size = 5
low_velocity_bucket_size = 3  # Can be set to binary, will then only look at sign

high_tree_dist_bin_size = 120  # Can be set to 0, will then discard this variable
high_relative_dist_bin_size = 2
high_velocity_bucket_size = 20  # Can be set to 'binary', will then only look at sign


class HighGTableLearner(object):
    ...
    def action_callback(self, state):
        ...
        # Calculate gravity in second tick
